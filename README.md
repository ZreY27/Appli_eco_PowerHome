...
│       │   └── res/...             # Ressources (layouts, icônes, thèmes)
│       └── test/                   # Tests unitaires et instrumentés
├── build.gradle                    # Configuration principale du projet
├── gradle.properties               # Propriétés globales
├── settings.gradle                 # Définition des modules
├── gradlew / gradlew.bat           # Exécution Gradle sans installation locale
...
Les droits sur les contenus textuels, graphiques et visuels appartiennent à leurs auteurs respectifs.
